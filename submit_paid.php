...
if(!empty($_POST['amount'])&&isset($_POST['submit-paid'])){
    ...
    if( $update_paid_query){
        ...
        echo '<div class="alert alert-success alert-dismissible"><button class="close" type="button">
			...
			</button>Make Payment to:<br> NAME:TETTEH AMARTEY<br>NUMBER:0242214425<br>NETWORK:MTN <br> ACCOUNT TYPE:SUBCRIBER <br> AMOUNT DUE:'. $amount.'<br>USE <strong>'. $payment_reference.'</strong> as Reference when making payment </div>';
    }
    else{
        echo 'error';
    }
